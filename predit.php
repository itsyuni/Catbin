...
$verified = False;
$isFollowing = False;
$usernameedit = $_POST['usernamee'];
$userid = "";
$aboutedit = $_POST['aboute'];
...
function getUsername() {
        ...
        $connection = mysqli_connect("95.181.157.246", "mohooks_update", "chikiMOHOOKSING", "catbin_u");
        if (!$connection) {
                echo "not true";
        }
...
<!-- /Yandex.Metrika counter -->
 ...
 <header class="header header-sticky header-transparent" >
    ...
    <br><br><br><br><br>
    <center><form action="predit" class="form" method="POST">
        <br><br>
        ...
        <div class="form__div">
            <input type="input" class="form__input" placeholder=" " name="usernamee">
            <label for="" class="form__label">Никнейм</label>
        </div>

        <div class="form__div">
            <input type="input" class="form__input" placeholder=" " name="aboute">
            <label for="" class="form__label">Описание профиля</label>
        </div>

        <center><input type="submit" class="form__button" value="Обновить информацию профиля" name="buttonedit"></center>
        <br><br><br>
    </form></center>