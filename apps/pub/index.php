...
<header class="header header-sticky header-transparent" >
    ...
    <div class="container padding">
        <div class="row padding">
            <div class="col-md-4">
                <div class="card">
                    <img src="/assets/img/cards/miniapps/calc.jpg" alt="Калькулятор">
                    <div class="card-body">
                        <span class="tag tag-apps">CatbinApps</span>
                        <br>
                        <h4 style="color: #000;" class="card-title">Калькулятор</h4>  
                        <p style="color: #000;" class="card-text">Отлично подойдёт для быстрого решения математических задач.</p>   
                        <center><a href="calc/" class="btn btn-warning">Перейти</a></center>
                    </div>
                </div>
            </div>
                <div class="col-md-4">
                <div class="card">
                    <img src="/assets/img/cards/miniapps/weather.jpg" alt="Калькулятор">
                    <div class="card-body">
                    <span class="tag tag-apps">CatbinApps</span>
                        <h4 style="color: #000;" class="card-title">Прогноз погоды</h4>  
                        <p style="color: #000;" class="card-text">Если сегодня пойдёт дождь, не забудьте взять красивый зонтик.</p>   
                        <center><a href="weather/" class="btn btn-warning">Перейти</a></center>
                    </div>
                </div>
            </div>
                <div class="col-md-4">
                <div class="card">
                    <img src="/assets/img/cards/miniapps/clock.jpg" alt="Калькулятор">
                    <div class="card-body">
                    <span class="tag tag-apps">CatbinApps</span>
                        <h4 style="color: #000;" class="card-title">Сколько времени?</h4>  
                        <p style="color: #000;" class="card-text">Можно посмотреть, сколько времени остаётся до каких-либо событий.</p>   
            ...
            <div class="col-md-4">
                <br><div class="card">
                    <img src="/assets/img/cards/miniapps/link.jpg" alt="Калькулятор">
                    <div class="card-body">
                    <span class="tag tag-apps">CatbinApps</span>
                        <h4 style="color: #000;" class="card-title">Сокращатель ссылок</h4>  
                        <p style="color: #000;" class="card-text">Сократите ссылку, сделайте её красивее!</p>   
                        <center><a href="link/" class="btn btn-warning">Перейти</a></center>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <br><div class="card">
                    <img src="/assets/img/cards/miniapps/paint.jpg" alt="Калькулятор">
                    <div class="card-body">
                    <span class="tag tag-apps">CatbinApps</span>
                        <h4 style="color: #000;" class="card-title">Paint</h4>  
                        <p style="color: #000;" class="card-text">Мы уважаем ваше творчество, рисуйте сколько душе угодно!</p>   
                        <center><a href="paint/" class="btn btn-warning">Перейти</a></center>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <br><div class="card">
                    <img src="/assets/img/cards/miniapps/music.jpg" alt="Калькулятор">
                    <div class="card-body">
                    <span class="tag tag-apps">CatbinApps</span>
                        <h4 style="color: #000;" class="card-title">Создание музыки</h4>  
                        <p style="color: #000;" class="card-text">Можно сделать свою музыку и без программ.</p>   
                        <center><a class="btn btn-secondary">В разработке</a></center>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    <div class="container padding">
        <div class="row padding">
            <div class="col-md-4">
                <div class="card">
                    <img src="/assets/img/cards/miniapps/ar-phone.jpg" alt="Калькулятор">
                    <div class="card-body">
                        <h4 style="color: #000;" class="card-title">AR-пространство</h4>  
                        <p style="color: #000;" class="card-text">Мы сами не знаем зачем это нужно, но пусть будет.</p>   
                        <center><a class="btn btn-secondary">В разработке</a></center>
                    </div>
                </div>
            </div>
