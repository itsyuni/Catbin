 ...
 <header class="header header-sticky header-transparent" >
    ...
    <div class="container padding">
        <div class="row padding">
            <div class="col-md-4">
                <div class="card">
                    <img src="/assets/img/cards/welcome/miniapps.png" alt="Калькулятор">
                    <div class="card-body">
                ...
                <div class="col-md-4">
                <div class="card">
                    <img src="/assets/img/cards/welcome/images.png" alt="Калькулятор">
                    <div class="card-body">
                        <h4 style="color: #000;" class="card-title">CatbinGames</h4>  
                        <p style="color: #000;" class="card-text">Игры в браузере, от разных авторов.</p>   
                        <center><a class="btn btn-dark">В разработке</a></center>
                    </div>
                </div>
            </div>
                <div class="col-md-4">
                <div class="card">
                    <img src="/assets/img/cards/welcome/labs.png" alt="Калькулятор">
                    <div class="card-body">
                        ...
                        <center><a class="btn btn-warning" href="/cbin/labs/">Перейти</a></center>
                    </div>
                </div>
            </div>
        </div>
