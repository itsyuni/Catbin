...
<!-- /Yandex.Metrika counter -->
 ...
 <header class="header header-sticky header-transparent" >
    ...
    <?php if($photourl) { ?>
        ...
        <center><br><br><input type="file" class="btn btn-primary" name="file"></input>
        ...
        <center><br><br><input type="file" class="btn btn-primary" name="image_file"></input>
        <br><input type="submit" class="btn btn-primary" value="Изменить фотографию профиля" name="filesubmit"></input></center> <?php
    } ?>
    <?php
