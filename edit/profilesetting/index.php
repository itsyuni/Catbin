...
<!-- /Yandex.Metrika counter -->
 ...
 <header class="header header-sticky header-transparent" >
    ...
    <br><br><br><br><br>
    <br><br><center><a href="imgprofile/" class="btn btn-primary" name="follow">Изменить пароль</a></center>
    <br><br><center><a href="profiledata/" class="btn btn-primary" name="follow">Изменить почту</a></center>
    <br><br><center><a href="profilesetting/" class="btn btn-primary" name="follow">Изменить настройки профиля</a></center>
    <br><br><center><a href="logout.php" class="btn btn-primary" name="follow">Выйти из аккаунта</a></center>