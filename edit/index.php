...
<!-- /Yandex.Metrika counter -->
 ...
 <header class="header header-sticky header-transparent" >
    ...
    <br><br><br><br><br>
    <br><br><center><button type="button" class="btn btn-secondary" data-toggle="tooltip" data-placement="top" title="Раздел в разработке">
                        Изменить фотографию профиля
                        </button></center>
    <br><br><center><a href="profiledata/" class="btn btn-primary" name="follow">Изменить информацию о себе</a></center>
    <br><br><center><button type="button" class="btn btn-secondary" data-toggle="tooltip" data-placement="top" title="Раздел в разработке">
