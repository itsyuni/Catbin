...
<!-- /Yandex.Metrika counter -->
 ...
 <header class="header header-sticky header-transparent" >
    ...
    <br><br><br><br><br>
    <center><h1 style="color: aliceblue;"><?php echo $username; if ($verified) { echo ' - официальный аккаунт'; } ?></h1></center>
    ...
    <?php
        if ($userid != $followerid) {
                if ($isFollowing) {
                        echo '<br><br><center><input type="submit" class="btn btn-primary" name="unfollow" value="Отписаться"></center>';
                } else {
                        echo '<br><br><center><input type="submit" class="btn btn-primary" name="follow" value="Подписаться"></center>';
                }
        }
        ?>
    </form>
