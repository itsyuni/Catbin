...
<script src="https://sindresorhus.com/devtools-detect/index.js"></script>
  ...
  <header class="header header-sticky header-transparent" >
    ...
    <br><br><br><br><br>
    <center><img width="100" height="100" src="/assets/img/server/server-upload_white.png"></center><br>
    <center><h2 style="position: fixed, center;">Публикация фотографий:</h2></center>
            <br>
            <form action="https://cbin.ml/i/u.php" method="POST" enctype="multipart/form-data">
            <br><br>
            <center><input class="btn btn-primary" type="file" name="userfile[]" id="" multiple=""></center>
            <br><center><input class="btn btn-primary" type="submit" name="userfileу" id="" value="Опубликовать"></center>
            </form>