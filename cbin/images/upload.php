...
<script src="https://sindresorhus.com/devtools-detect/index.js"></script>
  ...
  <header class="header header-sticky header-transparent" >
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <div class="navbar-nav ml-auto">
                        <li class="nav-item active"></li>
                            <a class="nav-item nav-link dropdown-toggledropdown-toggle active" href="#" id="dropdown-1" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Главная</a>
                            <a class="nav-item nav-link" href="/support">Помощь</a>
    ...
    <br><br><br><br><br>
    <center><img width="100" height="100" src="/assets/img/server/server_white.png"></center><br>
    <center><h2>Выберите сервер:</h2></center>
            <br>
            <div class="container padding">
        <div class="row padding">
            <div class="col-md-4">
                <div class="card">
                    <img src="/assets/img/flags/russia-1280720.png" alt="Калькулятор">
                    <div class="card-body">
                        <h4 style="color: #000;" class="card-title">Russia Moscow-M9</h4>  
                        <center><a href="srv/moscow/" class="btn btn-primary">Перейти</a></center>
                    </div>
                </div>
            </div>
                <div class="col-md-4">
                <div class="card">
                    <img src="/assets/img/flags/united-states-1280720.png" alt="Калькулятор">
                    <div class="card-body">
                        <h4 style="color: #000;" class="card-title">USA Central-5</h4>     
                        <center><a class="btn btn-secondary">Временно недоступен</a></center>
                    </div>
                </div>
            </div>
                <div class="col-md-4">
                <div class="card">
                    <img src="/assets/img/flags/europe-1280720.png" alt="Калькулятор">
                    <div class="card-body">
                        <h4 style="color: #000;" class="card-title">West Europe-3</h4>   
                        <center><a class="btn btn-secondary">Временно недоступен</a></center>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <br><div class="card">
                    <img src="/assets/img/flags/australia-1280720.png" alt="Калькулятор">
                    <div class="card-body">
                        <h4 style="color: #000;" class="card-title">Australia Southeast-1</h4>     
                        <center><a class="btn btn-secondary">Временно недоступен</a></center>
                    </div>
                </div>
            </div>
